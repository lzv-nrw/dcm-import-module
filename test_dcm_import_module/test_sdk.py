...
def _default_sdk():
    return dcm_import_module_sdk.DefaultApi(
        dcm_import_module_sdk.ApiClient(
            dcm_import_module_sdk.Configuration(
...
def test_default_ping(
    default_sdk: dcm_import_module_sdk.DefaultApi, app, run_service
):
...
def test_import_report(
    import_sdk: dcm_import_module_sdk.ImportApi, app, run_service,
    testing_config, fake_builder_service
):
    ...
    submission = import_sdk.import_external(
        {
            "import": {
                "plugin": "demo",
                "args": {
